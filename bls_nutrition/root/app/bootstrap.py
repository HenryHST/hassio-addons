...
def ensure_database() -> None:
    ...
    if settings.auto_update and not should_import:
        should_import = _needs_update(_version_info_path(settings.data_dir), settings.update_interval_days)
    ...
    data_path, components_path = download.extract_bls_files(zip_path, settings.downloads_dir)
